...
const STATIONS = [
  ...
  { naptanId: '940GZZLUPAD', name: 'Paddington', aliases: ['paddington'] },
  ...
  { naptanId: '940GZZLUCANW', name: 'Canary Wharf', aliases: ['canary wharf'] },
  ...
  { naptanId: '940GZZLUCTS', name: 'Camden Town', aliases: ['camden', 'camden town'] },
  ...
  { naptanId: '940GZZLUCLC', name: 'Clapham Common', aliases: ['clapham common'] },
  { naptanId: '940GZZLUCLJ', name: 'Clapham Junction', aliases: ['clapham junction'] },
  { naptanId: '940GZZLUCLS', name: 'Clapham South', aliases: ['clapham south', 'clapham'] },
  { naptanId: '940GZZLUWMP', name: 'Wembley Park', aliases: ['wembley', 'wembley stadium'] },
  { naptanId: '940GZZLUTFG', name: 'Tufnell Park', aliases: ['tufnell park'] },
